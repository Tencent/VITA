...
### NEED TO CHANGE ###
root_dir="path/to/libero_convert/"
libero_path="path/to/libero_convert/"
save_checkpoint_path="path/to/checkpoints/test/"
...
torchrun --nnodes=${node} --nproc_per_node=${node_num} --master_port=10211 train_ds.py \
    ...
    --wandb_project vita_libero_10_pt_frevlm_ft_nofrevlm_727 \
    --weight_decay 1e-4 \
    --num_resampler_query 6 \
    --run_name vita_libero_10_pt_frevlm_ft_nofrevlm_727\
