...
from ......model.multimodal_encoder.whale.module.layer.attention import (
    Conv1dLinear,
...
from ......model.multimodal_encoder.whale.utils import IGNORE_ID, add_optional_chunk_mask, strtobool
