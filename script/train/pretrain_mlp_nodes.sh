...
torchrun $DISTRIBUTED_ARGS vita/train/train.py \
    ...
    --model_name_or_path /mnt/shared/data1/lhj/model_weights/Mixtral-8x7B_modVocab/mg2hg \
    --model_type $MODEL_TYPE \
    --version mixtral_two \
    --dataset_use Pretrain_video \
    --vision_tower /mnt/shared/data1/lhj/model_weights/InternViT-300M-448px \
    --mm_projector_type mlp2x_gelu \
    --tune_mm_mlp_adapter True \
    --audio_encoder /mnt/shared/data1/lhj/model_weights/audio-encoder-2wh_zh_en_audioset_Mixtral-8x7B_New-base-tunning \
