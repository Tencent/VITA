...
class EVAViTTransformerLayer(TransformerLayer):
    def forward(
        self,
        hidden_states,
        attention_mask,
...
class EVA2ViTModel(VisionModule):
    ...
    def __init__(
        ...
        self.embedding = LanguageModelEmbedding(
            ...
            vocab_size=1,
            max_sequence_length=self.num_patches + 1,
    ...
    def forward(
        ...
        if self.add_class_token:
            class_token = self.embedding.word_embeddings.weight.unsqueeze(0).expand(
                x.shape[0], -1, -1
        ...
        x = x + self.embedding.position_embeddings(self.position_ids)
