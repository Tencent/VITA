...
######################################################################
DATA_PATH=${LOCAL_CODE_PATH}/configs/lcvlm_finetune_stage4.yaml
...
#CKPT_LOAD_DIR=${ROOT_PATH_2}/output/LM/lcvlm_modellink/scripts/qwen25/finetune_qwen25_14b_intern_300m_ptd_tp8pp1cp8_stage4.sh/20241126_080707/
