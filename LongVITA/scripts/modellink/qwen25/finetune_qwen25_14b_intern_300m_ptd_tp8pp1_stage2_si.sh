...
######################################################################
DATA_PATH=${LOCAL_CODE_PATH}/configs/lcvlm_finetune_stage2_si.yaml

TOKENIZER_PATH=${ROOT_PATH_4}/models/Qwen/Qwen2.5-14B-Instruct/
CKPT_LOAD_DIR=${ROOT_PATH_2}/output/LM/lcvlm_modellink/scripts/qwen25/pretrain_qwen25_14b_intern_300m_ptd_tp8pp1_stage1.sh/20241012_095536/
#CKPT_LOAD_DIR=${ROOT_PATH_2}/output/LM/lcvlm_modellink/scripts/qwen25/pretrain_qwen25_14b_intern_300m_ptd_tp8pp1_stage1.sh/20241031_094230/
