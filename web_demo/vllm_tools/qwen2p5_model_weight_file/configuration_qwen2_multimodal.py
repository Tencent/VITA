...
"""Multi-modal Qwen2 model configuration"""
...
class Qwen2MultiModalConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a `Qwen2MultiModal` model. It is used to instantiate a
    Qwen2MultiModal model according to the specified arguments, defining the model architecture. Instantiating a configuration
    ...
    ```python
    >>> from transformers import Qwen2MultiModalConfig, Qwen2MultiModalModel

    >>> # Initializing a Qwen2MultiModal configuration
    >>> configuration = Qwen2MultiModalConfig()

    >>> # Initializing a model from the configuration
    >>> model = Qwen2MultiModalModel(configuration)
