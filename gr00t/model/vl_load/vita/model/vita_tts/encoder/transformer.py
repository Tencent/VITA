...
from vl_load.vita.model.vita_tts.masks import *
...
class MultiSequential(torch.nn.Sequential):
    ...
    def forward(self, x, masks, pos_emb):
        for layer_mod in self:
            x, masks, pos_emb = layer_mod(x, masks, pos_emb)
    ...
    def infer(self, x, pos_emb, buffer, buffer_index, buffer_out):
        ...
        for sub_block in self:
            x, pos_emb, buffer, buffer_index, buffer_out = sub_block.infer(x, pos_emb, buffer, buffer_index, buffer_out)
