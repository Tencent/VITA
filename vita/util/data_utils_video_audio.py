...
from vita.constants import IGNORE_INDEX, DEFAULT_IMAGE_TOKEN, MAX_IMAGE_LENGTH, MIN_IMAGE_LENGTH, DEFAULT_VIDEO_TOKEN, DEFAULT_AUDIO_TOKEN
...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'image' in sources[0] and "audio" not in sources[0]:
            ...
            image, image_token_num = _get_rawvideo_dec(os.path.join(video_folder, video_file), processor, max_frames=MAX_IMAGE_LENGTH, min_frames=MIN_IMAGE_LENGTH, image_resolution=image_size)
