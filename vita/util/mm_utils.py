...
from vita.constants import IMAGE_TOKEN_INDEX, AUDIO_TOKEN_INDEX
...
def tokenizer_image_audio_token(prompt, tokenizer, image_token_index=IMAGE_TOKEN_INDEX, audio_token_inde=AUDIO_TOKEN_INDEX, return_tensors=None):
    prompt_chunks = []
