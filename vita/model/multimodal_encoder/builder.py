...
#    configs['model_conf']['freeze_adpter'] = audio_encoder_config.freeze_audio_encoder_adapter
    configs['model_conf']['freeze_encoder'] = getattr(audio_encoder_config, "freeze_audio_encoder", True)
    configs['model_conf']['freeze_adpter'] = getattr(audio_encoder_config, "freeze_audio_encoder_adapter", True)
