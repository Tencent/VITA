...
from vita.model.multimodal_encoder.whale.utils import strtobool, IGNORE_ID
...
class MambaSSM(torch.nn.Module):
    ...
    def add_arguments(group):
        ...
        group.add_argument('--mamba-num-layers', default=4, type=int, help="Output dim of MambaSSM.")
        group.add_argument('--mamba-input-dim', default=256, type=int, help="Input dim of MambaSSM.")
        group.add_argument('--mamba-output-dim', default=256, type=int, help="Output dim of MambaSSM.")
    ...
    def __init__(self, args):
        ...
        self.mamba = MambaBlock(self.mamba_input_dim, self.mamb_num_layers, self.mamba_d_state, self.mamba_d_conv, self.mamba_expand)
